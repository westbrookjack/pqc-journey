...
// this is the inverse of AES_SBOX in the sense that AES_INV_SBOX[AES_SBOX[x]] == x 
...
pub const AES_MIX_COLUMNS: [u8; 16] = [
    2, 3, 1, 1,
    1, 2, 3, 1,
    1, 1, 2, 3,
    3, 1, 1, 2
...
pub const AES_INV_MIX_COLUMNS: [u8; 16] = [
    14, 11, 13,  9,
     9, 14, 11, 13,
    13,  9, 14, 11,
    11, 13,  9, 14,
